...
class UserResourse(resources.ModelResource):
    ...
    class Meta:
        model = User
        exclude = ('id','last_login', 'is_superuser', 'user_permissions', 'date_joined', 'is_active', 'groups')
        import_id_fields = ('password', 'username', 'first_name', 'last_name', 'email', 'is_staff')
...
admin.site.site_header = 'Administrator System'
